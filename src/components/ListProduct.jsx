          ...
          {products.map((product) => (
            <tr key={product.id} className="border-b p-4 bg-slate-200 mb-2">
              ...
              <td className="px-4 py-3">
                ...
                <button className="px-4 mb-2 py-1 bg-blue-500 hover:bg-blue-400 text-white text-center items-center rounded">
                  <Link to={`/ProductUpdate/${product.id}`} className=""> Editar</Link>
                </button>
                <button className="px-2 mb-2 py-1 bg-red-500 hover:bg-red-400 text-white text-center items-center rounded" onClick={() => handleDelete(product.id)}>Eliminar</button>
                <button className="px-4 mb-2 py-1 bg-green-500 hover:bg-green-400 text-white text-center items-center rounded">
                  <Link to={`/ProductUpdate/${product.id}`} className="">Vender</Link>
                </button>
